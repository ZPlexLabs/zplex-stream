/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0a13e8969aecf47e15204cabb0556490)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		GOOGLE_DRIVE_PRIVATE_KEY_ID: string;
		SECRET_KEY: string;
		GOOGLE_DRIVE_PRIVATE_KEY_PKCS8: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_DRIVE_CLIENT_EMAIL" | "GOOGLE_DRIVE_CLIENT_ID" | "GOOGLE_DRIVE_PRIVATE_KEY_ID" | "SECRET_KEY" | "GOOGLE_DRIVE_PRIVATE_KEY_PKCS8">> {}
}
